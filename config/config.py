...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","Onedio Music")
...
GIT_TOKEN = getenv("GIT_TOKEN", "6591274198:AAFFsE0pTw3tUE9kq49QjUBarwLaQTdjurY")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/TheYukki")
